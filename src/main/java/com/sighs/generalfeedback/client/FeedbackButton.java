...
public class FeedbackButton extends CustomButton {
    private static final ResourceLocation BUTTON_NORMAL_TEXTURE = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/feedback_0.png");
    private static final ResourceLocation BUTTON_PRESSED_TEXTURE = ResourceLocation.fromNamespaceAndPath(MODID, "textures/gui/feedback_1.png");
